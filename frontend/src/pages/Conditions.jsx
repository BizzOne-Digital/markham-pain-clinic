...
export default function Conditions() {
  ...
  return (
    <>
      <SEO title="Conditions Treated" description="Conditions treated at Markham Pain Clinic including back pain, sports injuries, sciatica and more." path="/conditions" />
