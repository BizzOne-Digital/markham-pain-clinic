...
const CONDITION_ITEMS = [
  { label: 'Vertigo', to: '/conditions' },
  { label: 'Back Pain', to: '/conditions' },
  { label: 'Wrist Pain', to: '/conditions' },
  { label: 'Headaches', to: '/conditions' },
  { label: 'Chronic Pain', to: '/conditions' },
  { label: 'Shoulder Pain', to: '/conditions' },
  { label: 'Balance Disorder', to: '/conditions' },
  { label: 'Fibromyalgia Treatment', to: '/conditions' },
  { label: 'Hip Pain', to: '/conditions' },
  { label: 'Neck Pain', to: '/conditions' },
  { label: 'Hand Pain', to: '/conditions' },
  { label: 'Elbow Pain', to: '/conditions' },
  { label: 'Sciatica', to: '/conditions' },
  { label: 'Gait Disorders', to: '/conditions' },
  { label: 'Arthritis Treatment', to: '/conditions' },
  { label: 'Motor Vehicle Accident Injuries', to: '/conditions' },
  { label: 'Foot Pain', to: '/conditions' },
  { label: 'Knee Pain', to: '/conditions' },
  { label: 'Ankle Pain', to: '/conditions' },
  { label: 'Concussions', to: '/conditions' },
  { label: 'WSIB Injuries', to: '/conditions' },
  { label: 'Dance Injuries', to: '/conditions' },
  { label: 'Dizziness Treatment', to: '/conditions' },
