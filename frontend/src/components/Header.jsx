...
const SERVICE_ITEMS = [
  ...
  { label: 'Spinal Manipulation/Adjustment', to: '/services/spinal-manipulation-adjustment' },
  ...
  { label: 'Return to Work/Play', to: '/services/return-to-work-play' },
...
const CONDITION_ITEMS = [
  { label: 'Vertigo Treatment in Markham', to: '/conditions/vertigo' },
  { label: 'Back Pain Treatment in Markham', to: '/conditions/back-pain' },
  { label: 'Wrist Pain Treatment in Markham', to: '/conditions/wrist-pain' },
  { label: 'Headaches Treatment in Markham', to: '/conditions/headaches' },
  { label: 'Chronic Pain Treatment in Markham', to: '/conditions/chronic-pain' },
  { label: 'Shoulder Pain Treatment in Markham', to: '/conditions/shoulder-pain' },
  { label: 'Balance Disorder Treatment in Markham', to: '/conditions/balance-disorder' },
  { label: 'Fibromyalgia Treatment in Markham', to: '/conditions/fibromyalgia-treatment' },
  { label: 'Hip Pain Treatment in Markham', to: '/conditions/hip-pain' },
  { label: 'Neck Pain Treatment in Markham', to: '/conditions/neck-pain' },
  { label: 'Hand Pain Treatment in Markham', to: '/conditions/hand-pain' },
  { label: 'Elbow Pain Treatment in Markham', to: '/conditions/elbow-pain' },
  { label: 'Sciatica Pain Treatment in Markham', to: '/conditions/sciatica-pain' },
  { label: 'Gait Disorders Treatment in Markham', to: '/conditions/gait-disorders' },
  { label: 'Arthritis Treatment in Markham', to: '/conditions/arthritis-treatment' },
  { label: 'Motor Vehicle Accident Injuries Treatment in Markham', to: '/conditions/motor-vehicle-accident-injuries' },
  { label: 'Foot Pain Treatment in Markham', to: '/conditions/foot-pain' },
  { label: 'Knee Pain Treatment in Markham', to: '/conditions/knee-pain' },
  { label: 'Ankle Pain Treatment in Markham', to: '/conditions/ankle-pain' },
  { label: 'Concussions Treatment in Markham', to: '/conditions/concussions' },
  { label: 'WSIB Injuries Treatment in Markham', to: '/conditions/wsib-injuries' },
  { label: 'Dance Injuries Treatment in Markham', to: '/conditions/dance-injuries' },
  { label: 'Dizziness Treatment in Markham', to: '/conditions/dizziness-treatment' },
]
