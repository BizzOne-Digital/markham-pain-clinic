...
const serviceSchema = new mongoose.Schema(
  {
    ...
    whoCanBenefitDetails: { type: [detailBlockSchema], default: [] },
    conditionsTreated: [{ type: String, trim: true }],
    conditionsTreatedDetails: { type: [detailBlockSchema], default: [] },
    treatmentProcess: [{ type: String, trim: true }],
    treatmentProcessDetails: { type: [detailBlockSchema], default: [] },
